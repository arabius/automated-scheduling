...
public record NotSameRoomJustification(Room room, Lesson lesson1, Lesson lesson2, String description)
        implements
            ConstraintJustification {

    public NotSameRoomJustification(Room room, Lesson lesson1, Lesson lesson2) {
