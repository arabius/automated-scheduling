...
public class RoomSoftConstraints implements ConstraintProviderInterface {
...
//     }
    ...
    private Constraint roomCapacityGreaterThanTwoForOnline(ConstraintFactory constraintFactory) {
        return constraintFactory
                .forEach(Lesson.class)
